  ...
  return (
    <div className="min-h-screen flex flex-col bg-background">
      ...
      <main className="flex-1 mx-auto max-w-5xl w-full px-6 lg:px-10 py-8">
        ...
        <div className="mb-8 flex flex-wrap items-end justify-between gap-6">
          <div>
            ...
            <p className="text-base text-muted-foreground mt-2 max-w-xl">
              Move funds from your {branding.walletName} to a {branding.payeeSingular.toLowerCase()} —
        ...
        {/* Balance summary - Result card style */}
        <section className="rounded-2xl bg-primary text-primary-foreground p-6 mb-6 flex flex-wrap items-end justify-between gap-4">
          ...
          <Link
            ...
            className="rounded-full bg-background text-foreground px-5 h-11 text-sm font-bold inline-flex items-center hover:bg-background/90 transition-colors"
          >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <InfoCard
            label="How it works"
            title={`From ${branding.walletName} to bank`}
            items={[
          ...
          <InfoCard
            label="Quick tips"
            title={`Run a smooth ${branding.payoutNoun.toLowerCase()}`}
            items={[
