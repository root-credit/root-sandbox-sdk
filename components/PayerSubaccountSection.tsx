  ...
  return (
    <Card className="mb-6 rounded-2xl border-2">
      <CardHeader>
        ...
        <CardDescription>
          Your in-app balance for running payroll and {branding.payoutVerb.toLowerCase()}-ing
            ...
            {!hasLinkedBank ? (
              ...
              <form onSubmit={handleSubmit(onPayinSubmit)} className="flex flex-col gap-4">
                ...
                <Button
                  type="submit"
                  disabled={payinBusy}
                  className="rounded-lg font-bold bg-primary text-primary-foreground hover:bg-primary/90"
                >
                  {payinBusy ? (
                    <>
