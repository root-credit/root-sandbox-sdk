...
export function DashboardOverviewHero() {
  ...
  return (
    <div className="mt-7 flex flex-col gap-3 sm:flex-row sm:items-stretch">
      <div className="flex flex-col justify-between rounded-2xl border-2 bg-primary text-primary-foreground px-5 py-4 sm:min-w-72">
        ...
        <div className="flex items-end gap-3 mt-1">
          ...
          <span className="rounded-lg bg-primary-foreground text-primary px-2.5 py-1 text-[10px] font-bold uppercase tracking-widest mb-1">
            Live
          </span>
        </div>
      </div>
      <div className="flex flex-1 flex-wrap items-center gap-2 rounded-2xl border-2 bg-card px-5 py-4">
        ...
        <Pill label="Total paid" value="$0.00" />
      </div>
    </div>
  );
}
