      ...
      <section className="flex-1 flex items-center relative overflow-hidden">
        ...
        <div className="mx-auto w-full max-w-md px-6 py-16">
          <div className="text-center mb-8">
            <h1 className="text-3xl font-extrabold tracking-tight">Create your {branding.productName} account</h1>
            <p className="text-muted-foreground mt-2">
              Start buying and selling crypto today.
            </p>
          </div>
          ...
          <div className="rounded-2xl border border-border bg-card p-7 shadow-xl">
            ...
            <div className="relative my-6">
              ...
              <div className="relative flex justify-center text-xs uppercase">
                <span className="bg-card px-2 text-muted-foreground font-bold tracking-widest">Already have an account?</span>
              </div>
            </div>
            <Link
              href="/login"
