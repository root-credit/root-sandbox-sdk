  ...
  return (
    <Card className="mb-6 rounded-2xl border-2">
      <CardHeader>
        ...
        <CardDescription>
          Your in-app balance for sending money and {branding.payoutVerb.toLowerCase()}-ing
      ...
      <CardContent className="flex flex-col gap-6">
        <div className="flex flex-col gap-4 rounded-xl border-2 bg-secondary p-4 sm:flex-row sm:items-center sm:justify-between">
          <div className="space-y-1">
            ...
            <p className="text-xs text-muted-foreground">
              Provisions a Root subaccount to back your {branding.walletName} and ACH payins.
            </p>
          </div>
          <ToggleSwitch
        ...
        {subaccountEnabled ? (
          <div className="flex flex-col gap-4 rounded-xl border-2 bg-secondary p-4">
            <div>
              <p className="text-sm font-bold">Top up {branding.walletName} (ACH pull)</p>
            ...
            {!hasLinkedBank ? (
              <p className="text-sm font-semibold text-amber-700 dark:text-amber-400">
                Link your {branding.funderShortLabel.toLowerCase()} above before topping up your {branding.walletName}.
              </p>
            ) : (
